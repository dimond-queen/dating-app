...
import { Settings, Save, AlertCircle, CheckCircle, Eye, EyeOff, Database, FileText } from 'lucide-react'
...
export default function Admin() {
  ...
  const [activeTab, setActiveTab] = useState('agora') // 'agora', 'settings', 'database', 'logs'
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-pink-50 to-red-50 py-8">
      <div className="max-w-6xl mx-auto px-4">
        ...
        <div className="bg-white rounded-t-2xl shadow-xl overflow-hidden mb-6">
